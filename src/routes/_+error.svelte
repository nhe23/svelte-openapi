...
<div class="h-screen w-screen grid place-items-center">
	<div class="flex flex-wrap items-center max-w-7xl gap-4">
		<div class="flex-1">
			<h1 class="text-5xl">Oh no! Something went wrong</h1>
			<div class="text-xl">{$page.status}: {$page?.error?.message}</div>
		</div>
		...
		<svg
			...
			/><rect
				...
				height="267.83694"
				fill="#3f3d56"
			/><circle cx="835.05948" cy="223.29299" r="3.02983" fill="#f2f2f2" /><path
			...
			/><rect x="87.60911" y="237" width="250" height="86" fill="#3f3d56" /><rect
				...
				height="86"
				fill="#3f3d56"
			/><rect x="271.60911" y="150" width="16" height="16" fill="#04bf8a" opacity="0.4" /><rect
				x="294.60911"
				y="150"
				width="16"
				height="16"
				fill="#04bf8a"
				opacity="0.8"
			/><rect x="317.60911" y="150" width="16" height="16" fill="#04bf8a" /><rect
				x="271.60911"
				y="251"
				width="16"
				height="16"
				fill="#04bf8a"
				opacity="0.4"
			/><rect x="294.60911" y="251" width="16" height="16" fill="#04bf8a" opacity="0.8" /><rect
				x="317.60911"
				y="251"
				width="16"
				height="16"
				fill="#04bf8a"
			/><rect x="271.60911" y="352" width="16" height="16" fill="#04bf8a" opacity="0.4" /><rect
				x="294.60911"
				y="352"
				width="16"
				height="16"
				fill="#04bf8a"
				opacity="0.8"
			/><rect x="317.60911" y="352" width="16" height="16" fill="#04bf8a" /><circle
				cx="316.60911"
				cy="538"
				r="79"
				fill="#2f2e41"
